wget 'https://packages.microsoft.com/repos/edge/pool/main/m/microsoft-edge-stable/microsoft-edge-stable_116.0.1938.69-1_amd64.deb?brand=M102' -O 'software/microsoft-edge.deb'
